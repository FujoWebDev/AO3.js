...
export const workRatingsSchema = z.enum(WorkRatings);

export const workCategorySchema = z.enum(WorkCategory);

export const workWarningStatusSchema = z.enum(WorkWarningStatus);

export const workWarningsSchema = z.enum(WorkWarnings);
